var distros = [
			["Arch Linux", "https://www.archlinux.org/download/", "Arch is a very porewfull and customizable distro mainly used by linux enthusiasts or on servers"],
			["Antergos", "https://antergos.com/try-it/", "Antergos is a varient of Arch Linux that is designed to be easy to set up and use"],
			["Manjaro", "https://manjaro.org/get-manjaro/", "Manjaro is a user-friendly Linux distribution based on Arch Linux"],
			["Ubuntu", "https://www.ubuntu.com/download/desktop", "Ubuntu is a very popular and easy to use distro with many 'flavours' avalible for easy customization. It's great for beginners"],
			["KDE Neon", "https://neon.kde.org/download", "Neon is an easy to use distro based around the kde plasma desktop and other kde tools"],
			...
			["Fedora","https://getfedora.org/en/workstation/download","Fedora is a polished, easy to use operating system for laptop and desktop computers"],
			["Linux Lite","https://www.linuxliteos.com/download.php","Linux Lite is a very easy to use distro based on the latest LTS release of Ubuntu"]
			]
